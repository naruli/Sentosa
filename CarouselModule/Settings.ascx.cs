...
namespace Sentosa.Modules.CarouselModule
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    /// 
    /// Because the control inherits from CarouselModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : CarouselModuleModuleSettingsBase
    {
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                if (image != null && !String.IsNullOrEmpty(txtCaption.Text))
                {
                    ...
                    carousel.Link = txtLink.Text;
                    carousel.Page = "Home";
                    carousel.PathImage = FileManager.Instance.GetUrl(image);
                    carousel.Zone = txtZone.Text;
