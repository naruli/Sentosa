<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="Sentosa.Modules.CarouselModule.View" %>
<script type="text/javascript">
    ...
    loadCarousel('<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/CarouselModule/API/ModuleCarousel/GetCarousel?Page=Home');
</script>
