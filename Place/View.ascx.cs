...
namespace Sentosa.Modules.Place
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    /// 
    /// Because the control inherits from AttractionsModuleModuleBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// 
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class View : PlaceModuleBase, IActionable
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (currentUrl.Contains("attractions"))
                {
                    groupname = "attractions";
                    imagename = "icon-atractions.png";
                }
                else if (currentUrl.Contains("beaches"))
                {
                    groupname = "beaches";
                    imagename = "icon-beaches.png";
                }
                else if (currentUrl.Contains("nature"))
                {
                    groupname = "nature";
                    imagename = "icon-natures.png";
                }
                else if (currentUrl.Contains("events"))
                {
                    groupname = "events";
                    imagename = "icon-calendar.png";
                }
                else if (currentUrl.Contains("dining"))
                {
                    groupname = "dining";
                    imagename = "icon-dining.png";
                }
                else if (currentUrl.Contains("shops"))
                {
                    groupname = "shops";
                    imagename = "icon-shops.png";
                }
                else if (currentUrl.Contains("golf"))
                {
                    groupname = "golf";
                    imagename = "icon-golf.png";
                }
                else if (currentUrl.Contains("promotions"))
                {
                    groupname = "promotions";
                    imagename = "icon-promo.png";
                }
                else
                {
