...
namespace Sentosa.Modules.DiningDetailModule
{
    ...
    /// 
    /// Because the control inherits from DiningDetailModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : DiningDetailModuleModuleSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            try
            {
                if (Page.IsPostBack == false)
                {
                    ...
                    */
                    if (Settings.Contains("IdDining"))
                        txtId1.Value = Settings["IdDining"].ToString();
                }
            }
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                var detailController = new Models.DiningDetailController();
                if (!String.IsNullOrEmpty(txtTitle1.Text))
                {
                    ...
                    subPageModule.Promotion = txtPromotion1.Text;
