<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Settings.ascx.cs" Inherits="Sentosa.Modules.DiningDetailCarouselModule.Settings" %>
...
<script type="text/javascript">
    ...
    function deleteCarousel(DeleteClickedID) {
        ...
        $.ajax({
            url: '<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/DiningDetailCarouselModule/API/ModuleCarousel/DeleteCarousel',
            type: "POST",
    ...
    function loadCarousel(IdDetail) {
        $.getJSON(
            "<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/DiningDetailCarouselModule/API/ModuleCarousel/GetCarousel?Page=DDetail" + IdDetail,
            function (result) {
