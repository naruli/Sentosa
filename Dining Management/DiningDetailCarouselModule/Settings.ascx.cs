...
namespace Sentosa.Modules.DiningDetailCarouselModule
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    /// 
    /// Because the control inherits from DiningDetailCarouselModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : DiningDetailCarouselModuleModuleSettingsBase
    {
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                if (image != null && !String.IsNullOrEmpty(txtCaption.Text))
                {
                    ...
                    carousel.Page = "DDetail" + txtId1.Value;
