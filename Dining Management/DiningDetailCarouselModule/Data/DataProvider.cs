...
namespace Sentosa.Modules.DiningDetailCarouselModule.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Sentosa.Modules.DiningDetailCarouselModule.Data.SqlDataprovider,DiningDetailCarouselModule";
