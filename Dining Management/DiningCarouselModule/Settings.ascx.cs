...
namespace Sentosa.Modules.DiningCarouselModule
{
    ...
    /// 
    /// Because the control inherits from DiningCarouselModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : DiningCarouselModuleModuleSettingsBase
    {
