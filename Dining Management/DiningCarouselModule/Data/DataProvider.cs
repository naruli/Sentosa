...
namespace Sentosa.Modules.DiningCarouselModule.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Sentosa.Modules.DiningCarouselModule.Data.SqlDataprovider,DiningCarouselModule";
