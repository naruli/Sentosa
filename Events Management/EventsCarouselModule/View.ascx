<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="Sentosa.Modules.EventsCarouselModule.View" %>
<script type="text/javascript">
    function loadCarousel(url) {
        ...
        loadCarousel('<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/EventsCarouselModule/API/ModuleCarousel/GetCarousel?Page=Events');
</script>
