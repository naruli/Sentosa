<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Settings.ascx.cs" Inherits="Sentosa.Modules.EventsCarouselModule.Settings" %>
...
<script type="text/javascript">
    ...
    function deleteCarousel(DeleteClickedID) {
        ...
        $.ajax({
            url: '<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/EventsCarouselModule/API/ModuleCarousel/DeleteCarousel',
            type: "POST",
    ...
    function loadCarousel() {
        $.getJSON(
            "<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/EventsCarouselModule/API/ModuleCarousel/GetCarousel?Page=Events",
            function (result) {
