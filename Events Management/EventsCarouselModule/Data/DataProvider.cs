...
namespace Sentosa.Modules.EventsCarouselModule.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Sentosa.Modules.EventsCarouselModule.Data.SqlDataprovider,EventsCarouselModule";
