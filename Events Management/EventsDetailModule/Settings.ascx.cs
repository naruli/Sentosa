...
namespace Sentosa.Modules.EventsDetailModule
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    /// 
    /// Because the control inherits from EventsDetailModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : EventsDetailModuleModuleSettingsBase
    {
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                var detailController = new Models.EventsDetailController();
