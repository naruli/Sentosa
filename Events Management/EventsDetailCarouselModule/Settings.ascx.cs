...
namespace Sentosa.Modules.EventsDetailCarouselModule
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    /// 
    /// Because the control inherits from EventsDetailCarouselModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : EventsDetailCarouselModuleModuleSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            try
            {
                ...
                {
                    if (Settings.Contains("IdEvents"))
                        txtId1.Value = Settings["IdEvents"].ToString();
        ...
        public override void UpdateSettings()
        {
            ...
            if (image != null && !String.IsNullOrEmpty(txtCaption.Text))
            {
                ...
                carousel.Page = "EDetail" + txtId1.Value;
