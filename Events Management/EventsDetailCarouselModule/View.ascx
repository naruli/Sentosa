<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="Sentosa.Modules.EventsDetailCarouselModule.View" %>
...
<script type="text/javascript">
    function loadCarousel(url) {
        ...
        function loadEventDetail(IdDetail) {
            $.getJSON(
              "<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/EventsDetailCarouselModule/API/ModuleCarousel/GetEventsDetail?id=" + IdDetail,
           function (result) {
               var parsedTaskJSONObject = jQuery.parseJSON(result);
               $.each(parsedTaskJSONObject, function () {
    ...
    loadCarousel('<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/EventsDetailCarouselModule/API/ModuleCarousel/GetCarousel?Page=ADetail' + Id);
    loadEventDetail(Id);
</script>
