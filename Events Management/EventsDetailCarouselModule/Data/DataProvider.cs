...
namespace Sentosa.Modules.EventsDetailCarouselModule.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Sentosa.Modules.EventsDetailCarouselModule.Data.SqlDataprovider,EventsDetailCarouselModule";
