...
namespace Sentosa.Modules.ImportantCarouselModule.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Sentosa.Modules.ImportantCarouselModule.Data.SqlDataprovider,ImportantCarouselModule";
