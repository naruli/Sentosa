<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="Sentosa.Modules.ImportantCarouselModule.View" %>
<script type="text/javascript">
    function loadCarousel(url) {
        ...
        loadCarousel('<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/ImportantCarouselModule/API/ModuleCarousel/GetCarousel?Page=Important');
</script>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 nopadding">
                ...
                <%--<ul class="floating-breadcrumb">
                    ...
                    <li>•</li>
                    <li class="active"><a href="#">Important</a></li>
                </ul>--%>

                <div class="floating-breadcrumb" style="text-align:left">
