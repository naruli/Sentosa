<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Settings.ascx.cs" Inherits="Sentosa.Modules.BeachesDetailModule.Settings" %>
...
<h2 id="dnnSitePanel-FormSubMenuBeaches" class="dnnFormSectionHead"><a href="" class="">Form Add Sub Menu & Sub Page</a></h2>
    ...
    <fieldset>
        ...
        <div class="dnnFormItem">
            <dnn:label ID="lblSafetyTitle1" runat="server" Text="Safety Tips Title" />
            <asp:TextBox ID="txtSafetyTitle1" runat="server" />
        </div>

        <div class="dnnFormItem">
            <dnn:label ID="lblSafetyInfo1" runat="server" Text="Safety Tips Information" />
            <asp:TextBox ID="txtSafetyInfo1" runat="server" />
        </div>
         ...
         <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtInstruction1" runat="server" />
        </div>
    </fieldset>

<h2 id="dnnSitePanel-FormGalleryBeaches" class="dnnFormSectionHead"><a href="" class="">Form Add Gallery</a></h2>
