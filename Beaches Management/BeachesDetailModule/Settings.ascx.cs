...
namespace Sentosa.Modules.BeachesDetailModule
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    /// 
    /// Because the control inherits from BeachesDetailModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : BeachesDetailModuleModuleSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            try
            {
                if (Page.IsPostBack == false)
                {
                    ...
                    */
                    if (Settings.Contains("IdBeaches"))
                        txtId1.Value = Settings["IdBeaches"].ToString();
                }
            }
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                var detailController = new Models.BeachesDetailController();
                ...
                if (!String.IsNullOrEmpty(txtTitle1.Text))
                {
                    ...
                    subPageModule.SafetyTitle = txtSafetyTitle1.Text;
                    subPageModule.SafetyInfo = txtSafetyInfo1.Text;
