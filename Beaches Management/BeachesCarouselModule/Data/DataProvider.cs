...
namespace Sentosa.Modules.BeachesCarouselModule.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Sentosa.Modules.BeachesCarouselModule.Data.SqlDataprovider,BeachesCarouselModule";
