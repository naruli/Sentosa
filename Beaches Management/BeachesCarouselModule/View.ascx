<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="Sentosa.Modules.BeachesCarouselModule.View" %>
<script type="text/javascript">
    function loadCarousel(url) {
        ...
        loadCarousel('<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/BeachesCarouselModule/API/ModuleCarousel/GetCarousel?Page=Beaches');
</script>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 nopadding">
                ...
                <ul class="floating-breadcrumb">
                    ...
                    <li>•</li>
                    <li class="active"><a href="#">Beaches</a></li>
