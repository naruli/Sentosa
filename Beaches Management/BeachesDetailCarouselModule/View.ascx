<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="Sentosa.Modules.BeachesDetailCarouselModule.View" %>
<script type="text/javascript">
    function loadCarousel(url) {
        ...
        function loadBeachesDetail(IdDetail) {
            $.getJSON(
              "<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/BeachesDetailCarouselModule/API/ModuleCarousel/GetBeachesDetail?id=" + IdDetail,
           function (result) {
               var parsedTaskJSONObject = jQuery.parseJSON(result);
               $.each(parsedTaskJSONObject, function () {
    ...
    loadCarousel('<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/BeachesDetailCarouselModule/API/ModuleCarousel/GetCarousel?Page=BDetail' + Id);
    loadBeachesDetail(Id);
</script>
