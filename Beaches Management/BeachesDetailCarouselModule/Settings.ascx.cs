...
namespace Sentosa.Modules.BeachesDetailCarouselModule
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    /// 
    /// Because the control inherits from BeachesDetailCarouselModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : BeachesDetailCarouselModuleModuleSettingsBase
    {
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                if (image != null && !String.IsNullOrEmpty(txtCaption.Text))
                {
                    ...
                    carousel.Page = "BDetail" + txtId1.Value;
