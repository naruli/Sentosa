<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="Sentosa.Modules.AttractionsDetailCarouselModule.View" %>
<script type="text/javascript">
    function loadCarousel(url) {
     ...
     function loadAttractionsDetail(IdDetail) {
         $.getJSON(
           "<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/AttractionsDetailCarouselModule/API/ModuleCarousel/GetAttractionsDetail?id=" + IdDetail,
           function (result) {
               var parsedTaskJSONObject = jQuery.parseJSON(result);
               $.each(parsedTaskJSONObject, function () {
    ...
    loadCarousel('<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/AttractionsDetailCarouselModule/API/ModuleCarousel/GetCarousel?Page=ADetail' + Id);
    loadAttractionsDetail(Id);
</script>
