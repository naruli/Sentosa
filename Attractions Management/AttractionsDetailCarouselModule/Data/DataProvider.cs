...
namespace Sentosa.Modules.AttractionsDetailCarouselModule.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Sentosa.Modules.AttractionsDetailCarouselModule.Data.SqlDataprovider,AttractionsDetailCarouselModule";
