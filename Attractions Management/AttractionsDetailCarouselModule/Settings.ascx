<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Settings.ascx.cs" Inherits="Sentosa.Modules.AttractionsDetailCarouselModule.Settings" %>
...
<script type="text/javascript">
    ...
    function deleteCarousel(DeleteClickedID) {
        ...
        $.ajax({
            url: '<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/AttractionsDetailCarouselModule/API/ModuleCarousel/DeleteCarousel',
            type: "POST",
    ...
    function loadCarousel(IdDetail) {
        ...
        $.getJSON(
            "<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/AttractionsDetailCarouselModule/API/ModuleCarousel/GetCarousel?Page=ADetail" + IdDetail,
            function (result) {
	...
	<fieldset>
        <div class="dnnFormItem">
            ...
            <input type="hidden" name="ADetail" id="idText" value="" />
        </div>
        <div class="dnnFormItem">
