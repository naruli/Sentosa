<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Settings.ascx.cs" Inherits="Sentosa.Modules.AttractionsDetailModule.Settings" %>
...
<h2 id="dnnSitePanel-FormSubMenuAttractions" class="dnnFormSectionHead"><a href="" class="">Form Add Sub Menu & Sub Page</a></h2>
    ...
    <fieldset>
        ...
        <div class="dnnFormItem">
            <dnn:label ID="lblOpeningHour1" runat="server" Text="Opening Hour" />
            <asp:TextBox ID="txtOpeningHour1" runat="server" />
        </div>
         ...
         <%--<div class="dnnFormItem">
          ...
          <div class="dnnFormItem">
            <dnn:label ID="lblPrice1" runat="server" Text="Price" />
...
<h2 id="dnnSitePanel-FormGalleryAttractions" class="dnnFormSectionHead"><a href="" class="">Form Add Gallery</a></h2>
