<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="Sentosa.Modules.AttractionsDetailModule.View" %>
<script type="text/javascript">
    function GetAttractionsDetail(IdDetail) {
        $.getJSON(
           "<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/AttractionsDetailModule/API/ModuleAttractionsDetail/GetAttractionsDetail?id=" + IdDetail,
           function (result) {
    ...
    function GetGalleryDetail(IdDetail) {
        $.getJSON(
           "<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/AttractionsDetailModule/API/ModuleAttractionsDetail/GetGalleryDetail?id=" + IdDetail,
           function (result) {
               var parsedTaskJSONObject = jQuery.parseJSON(result);
               var counter = 0;
    ...
    function GetSubMenuPageDetail(IdDetail) {
        $.getJSON(
           "<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/AttractionsDetailModule/API/ModuleAttractionsDetail/GetSubPageDetail?id=" + IdDetail,
           function (result) {
               var parsedTaskJSONObject = jQuery.parseJSON(result);
               var counter = 0;
               $('nav.sub-nav ul').html('');
               ...
               $.each(parsedTaskJSONObject, function () {
                   ...
                   $('section.page-article article').append(
                       ...
                       (this.OpeningHour != "" ? '<p>Opening Hour : ' + this.OpeningHour + '</p>' : '') +
