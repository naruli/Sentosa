...
namespace Sentosa.Modules.AttractionsCarouselModule.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Sentosa.Modules.AttractionsCarouselModule.Data.SqlDataprovider,AttractionsCarouselModule";
