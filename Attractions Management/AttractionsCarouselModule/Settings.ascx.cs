...
namespace Sentosa.Modules.AttractionsCarouselModule
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    /// 
    /// Because the control inherits from AttractionsCarouselModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : AttractionsCarouselModuleModuleSettingsBase
    {
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                if (image != null && !String.IsNullOrEmpty(txtCaption.Text))
                {
                    ...
                    carousel.Page = "Attractions";
                    carousel.PathImage = FileManager.Instance.GetUrl(image);
                    carousel.Description = txtDescription.Text;
