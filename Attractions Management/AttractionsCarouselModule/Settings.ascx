<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Settings.ascx.cs" Inherits="Sentosa.Modules.AttractionsCarouselModule.Settings" %>
...
<script type="text/javascript">
    ...
    function deleteCarousel(DeleteClickedID) {
        ...
        $.ajax({
            url: '<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/AttractionsCarouselModule/API/ModuleCarousel/DeleteCarousel',
            type: "POST",
    ...
    function loadCarousel() {
        $.getJSON(
            "<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/AttractionsCarouselModule/API/ModuleCarousel/GetCarousel?Page=Attractions",
            function (result) {
