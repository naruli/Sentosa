...
namespace Sentosa.Modules.PlaceDetail.Models
{
    public class Place
    {
        ...
        public string AdmissionInfo { get; set; } //ticket (attraction,event) {sub menu : Tickets}
        public string OpeningHour { get; set; } // opening hour (attraction,nature) {sub menu : Visitor Information}
        public string NatureAgeRestrictions { get; set; }
        public string NatureGuidedTours { get; set; }//guided tours (nature) {sub menu : Visitor Information}
        ...
        public string Details { get; set; } //description (attraction,beaches,nature,event,dining,shop,golf,hotel&spa,promotion,islander) {sub menu : Overview}
        ...
        public string Price { get; set; } //pricing (attraction) {sub menu : Visitor Information}
        ...
        public string Instruction { get; set; } //instruction (attraction,beaches,nature,event) {sub menu : Visitor Information}
