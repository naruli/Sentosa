...
namespace Sentosa.Modules.PhotoModule
{
    ...
    /// 
    /// Because the control inherits from PhotoModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : PhotoModuleModuleSettingsBase
    {
                ...
                if (Page.IsPostBack == false)
                {
                    ...
                    */
                    if (Settings.Contains("PhotoTitle"))
                        TextTitle.Text = Settings["PhotoTitle"].ToString();

                    if (Settings.Contains("PhotoDesc"))
                        TextDescription.Text = Settings["PhotoDesc"].ToString();
                }
            }
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                {
                    modules.UpdateModuleSetting(ModuleId, "PhotoTitle", TextTitle.Text);
                }
                else
                {
                ...
                {
                    modules.UpdateModuleSetting(ModuleId, "PhotoDesc", TextDescription.Text);
                }
                else
                {
