<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Settings.ascx.cs" Inherits="Sentosa.Modules.CarouselModule.Settings" %>
...
<script type="text/javascript">
    ...
    function deleteCarousel(DeleteClickedID) {
        ...
        $.ajax({
            url: '<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/CarouselModule/API/ModuleCarousel/DeleteCarousel',
            type: "POST",
    ...
    function loadCarousel() {
        $.getJSON(
            "<%=(Request.ApplicationPath.Equals("/") ? "" : Request.ApplicationPath)%>/DesktopModules/CarouselModule/API/ModuleCarousel/GetCarousel?Page=Home",
            function (result) {
	...
	<fieldset>
        ...
        <div class="dnnFormItem">
            <dnn:label ID="lblLink" runat="server" Text="Link" />
            <asp:TextBox ID="txtLink" runat="server" placeholder="/Explore/Attractions" />
        </div>
        <div class="dnnFormItem">
            <dnn:label ID="lblZone" runat="server" Text="Button Caption" />
